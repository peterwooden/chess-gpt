...
- **Training-compute limit:** Producing a submitted checkpoint may use at most 1 exaFLOP of training compute across its entire training lineage, measured by the same agreed profiler regardless of local or cloud hardware.
