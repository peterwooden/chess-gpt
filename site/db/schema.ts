...
export const liveGames = sqliteTable("live_games", {
  ...
  whiteMoveTimeLimitMs: integer("white_move_time_limit_ms"),
  blackMoveTimeLimitMs: integer("black_move_time_limit_ms"),
  ...
  activeTurnColor: text("active_turn_color", { enum: ["w", "b"] }),
  activeTurnElapsedMs: integer("active_turn_elapsed_ms"),
